...
//  }
  ...
  public function has_double_slashes_except_protocol($str) {
    $protocol = '';
    ...
    return strpos($str, '//') !== false && strpos($str, '//', strpos($str, '//') + 2) === false;

  }
      
  public function remove_double_slash_except_protocol($str) {
    $protocol = '';
    if (strpos($str, 'http://') === 0) {
      $protocol = 'http://';
      $str = substr($str, 7);
  ...
  public function remove_double_backslash($str) {
    while(strpos($str, '\\\\') !== false) {
      $str = str_replace('\\\\', '\\', $str);
    }
    return $str;
